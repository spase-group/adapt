...
#      grep '	'$SPASE_RESOURCE_ID'	' person_mission_nasa_all.tab | grep -v '	MetadataContact'$ | awk 'BEGIN { FS="	" } ; { print $3 }' | uniq
...
#          echo HELP'	'$SPASE_PERSON_NAME_MATCH'	'$SPASE_PERSON_NAME
