...
if [ $SPASE_RESOURCE_TYPE != "Person" ]; then
   ...
   echo '<Spase xmlns="http://www.spase-group.org/data/schema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.spase-group.org/data/schema http://www.spase-group.org/data/schema/spase-2_4_1.xsd">' >> $COLLATION_FILE_NAME

   echo '   <Version>2.4.1</Version>' >> $COLLATION_FILE_NAME
