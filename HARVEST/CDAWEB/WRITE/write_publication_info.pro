...
xml_element_write,publication_info.authors,spase_ontology(1),publication_info_xml,index,blank_check=blank_check,preview=preview

xml_element_write,publication_info.publication_date,spase_ontology(2),publication_info_xml,index,blank_check=blank_check,preview=preview

xml_element_write,publication_info.published_by,spase_ontology(3),publication_info_xml,index,blank_check=blank_check,preview=preview
