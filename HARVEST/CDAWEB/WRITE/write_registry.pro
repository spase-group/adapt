...
temp_xml=xml_structure_write(registry.resource_header,registry_xml,index,spase_ontology(2:37),preview=preview,full=full)

temp_xml=xml_structure_write(registry.access_url,registry_xml,index,spase_ontology(38:44),preview=preview,full=full)

xml_element_write,registry.extension,spase_ontology(45),registry_xml,index,blank_check=blank_check,preview=preview
