...
temp_xml=xml_structure_write(parameter.particle,parameter_xml,index,spase_ontology(61:105),preview=preview,full=full)

temp_xml=xml_structure_write(parameter.wave,parameter_xml,index,spase_ontology(106:135),preview=preview,full=full)

temp_xml=xml_structure_write(parameter.mixed,parameter_xml,index,spase_ontology(136:139),preview=preview,full=full)

temp_xml=xml_structure_write(parameter.support,parameter_xml,index,spase_ontology(140:142),preview=preview,full=full)
