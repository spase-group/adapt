...
temp_xml=xml_structure_write(access_information.data_extent,access_information_xml,index,spase_ontology(13:16),preview=preview,full=full)

xml_element_write,access_information.acknowledgement,spase_ontology(17),access_information_xml,index,blank_check=blank_check,preview=preview
