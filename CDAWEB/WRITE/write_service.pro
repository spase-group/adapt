...
temp_xml=xml_structure_write(service.resource_header,service_xml,index,spase_ontology(2:39),preview=preview,full=full)

temp_xml=xml_structure_write(service.access_url,service_xml,index,spase_ontology(40:46),preview=preview,full=full)

xml_element_write,service.extension,spase_ontology(47),service_xml,index,blank_check=blank_check,preview=preview
