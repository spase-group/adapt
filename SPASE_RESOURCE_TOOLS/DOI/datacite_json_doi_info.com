...
curl -kSs https://api.datacite.org/dois/application/vnd.datacite.datacite+json/10.48322/$DOI >& $JSON_FILE_NAME

curl -kSs https://api.datacite.org/dois/application/vnd.datacite.datacite+xml/10.48322/$DOI >& $XML_FILE_NAME
