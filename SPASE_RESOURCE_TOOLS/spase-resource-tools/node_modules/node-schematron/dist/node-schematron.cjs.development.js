...
var slimdomSaxParser = require('slimdom-sax-parser');
...
var Assert = /*#__PURE__*/function () {
  ...
  _proto.createMessageString = function createMessageString(contextNode, variables, fontoxpathOptions, chunks) {
    return chunks.map(function (chunk) {
      ...
      if (chunk.$type === 'name') {
        return fontoxpath.evaluateXPathToString('name(' + (chunk.path || '') + ')', contextNode, null, variables, fontoxpathOptions);
      } // <sch:value-of />


      if (chunk.$type === 'value-of') {
        return fontoxpath.evaluateXPathToString(chunk.select, contextNode, null, variables, fontoxpathOptions);
      }
  ...
  _proto.validateNode = function validateNode(context, variables, fontoxpathOptions) {
    var outcome = fontoxpath.evaluateXPathToBoolean(this.test, context, null, variables, fontoxpathOptions);
...
var Variable = /*#__PURE__*/function () {
  ...
  Variable.reduceVariables = function reduceVariables(context, variables, fontoxpathOptions, initial) {
    return variables.reduce(function (mapping, variable) {
      ...
      return Object.assign(mapping, (_Object$assign = {}, _Object$assign[variable.name] = variable.value ? fontoxpath.evaluateXPath(variable.value, context, null, mapping, undefined, fontoxpathOptions) : context, _Object$assign));
    }, initial || {});
  };
...
var Pattern = /*#__PURE__*/function () {
  ...
  _proto.validateDocument = function validateDocument(documentDom, parentVariables, fontoxpathOptions) {
    ...
    var ruleContexts = this.rules.map(function (rule) {
      return fontoxpath.evaluateXPathToNodes('//(' + rule.context + ')', documentDom, null, variables, fontoxpathOptions);
    });
...
var Schema = /*#__PURE__*/function () {
  ...
  _proto.validateString = function validateString(documentXmlString, options) {
    ...
    return this.validateDocument(slimdomSaxParser.sync(documentXmlString), options);
  };
  ...
  Schema.fromDomToJson = function fromDomToJson(schematronDom) {
    return fontoxpath.evaluateXPath(Schema.QUERY, schematronDom, null, {}, undefined, {
  ...
  Schema.fromString = function fromString(schematronXmlString) {
    return Schema.fromDom(slimdomSaxParser.sync(schematronXmlString));
  };
...
Object.defineProperty(exports, 'registerCustomXPathFunction', {
  enumerable: true,
  get: function () {
    return fontoxpath.registerCustomXPathFunction;
  }
});
exports.Schema = Schema;
//# sourceMappingURL=node-schematron.cjs.development.js.map
